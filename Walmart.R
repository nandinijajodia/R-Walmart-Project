...
store_sales = aggregate(Weekly_Sales~Store,data=walmart, sum) # Aggregate sales data store-wise and get total sale
...
#### Q2: Which store has maximum standard deviation i.e., the sales vary a lot. Also, find out the coefficient of variation for each store which is the ratio of standard deviation to mean.
